...
<html>
  ...
  background-size: cover;
	...
	<center><img src="images/lvl2/Gryffindor_common_room.jpg"  usemap="#commonroom1" onclick="alert('nothing happened') "   ></center><br><Br><br>
    <map name="commonroom1"><area shape='rectangle' coords="135,430,200,455" onclick="window.location.href='marauders_map.php'"/>
        <map name="commonroom1"><area shape='rectangle' coords="157,368,254,410" onclick="window.location.href='floo.php'"/>
