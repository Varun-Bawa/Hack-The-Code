...
<html>
  ...
  background-size: cover;
	...
	<center><img src="images/lvl2/stairs.jpg" usemap="#stairs" onclick="alert('nothing happened') "></center><br><Br><br>
        <map name="stairs"><area shape='rectangle' coords="100,3,194,78" onclick="window.location.href='fatlady.php'"/></map>map>
