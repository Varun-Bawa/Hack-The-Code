...
<html>
  ...
  background-size: cover;
	...
	<center><img src="images/lvl2/albus.jpg"  usemap="#map" onclick="alert('nothing happened') "   ></center><br><Br><br>
    <map name="map"><area shape='rectangle' coords="405,35,715,200" onclick="window.location.href='commonroom1.php'"/></map>
