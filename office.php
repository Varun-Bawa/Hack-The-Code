...
<html>
	...
	<title>Albus Dumbledore's Office</title>
	<style>
		body { 
  ...
  background-size: cover;
	...
	<center><img src="images/lvl2/office.jpg" usemap="#office" onclick="alert('nothing happened') "></center><br><Br><br>
        <map name="office"><area shape='rectangle' coords="490,177,558,194" onclick="window.location.href='pensieve.php'"/></map>    
