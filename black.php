...
if(isset($_SESSION['email']))
{
	...
	{
		if($_POST['lvl1answer'] == "mimbulus mimbletonia")
		{
...
<html>
	...
	<title>Harry! It's too dark in here </title>
	<style>
		body { 
  ...
  background-size: cover;
	...
	<form method="POST" action="commonroom.php">
	<center><img src="images/lvl2/black.jpg"   ></center><br><Br><br>
